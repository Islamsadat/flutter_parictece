...
class Stackproductcard extends StatefulWidget {
  const Stackproductcard({super.key});

  @override
  State<Stackproductcard> createState() => _Stackproductcard();
}

class _Stackproductcard extends State<Stackproductcard> {
  List<Map> ShoesList = [
              ...
              Flexible(
                child: Positioned(
                  ...
                  child: Container(
                    ...
                    height: 450,
                    // color: Colors.amber,
                    child: Image.asset('assets/shoess-removebg-preview.png'),
                  ),
                ),
              ),
            ],
